...
created:	Fri Dec 10 21:53:35 2021
tab-width:	4 spaces
...
/*
Me myself could only figure it out that 
...
void open(int pos, int l, int r, int idx) {
	...
	for (int mk = 0; mk < (1<<8); mk++) {
		...
		//     which bitset had this bit missing
		if ((mk>>bit)&1)
